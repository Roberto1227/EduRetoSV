/*ScrollReveal Animations para ingles.html*/
document.addEventListener('DOMContentLoaded', function() {
    ...
    sr.reveal('.ingles-intro-section .sectiontitle', {
        origin: 'top',
        distance: '40px',
        duration: 1500,
        delay: 200
    ...
    sr.reveal('.thought-bubble-english', {
        origin: 'right',
        distance: '60px',
        duration: 2000,
        delay: 400
    ...
    sr.reveal('.juegos-ingles-section .sectiontitle', {
        origin: 'top',
        distance: '40px',
        duration: 1500,
        delay: 200
