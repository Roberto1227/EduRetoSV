/*ScrollReveal Animations para ciencia.html*/
document.addEventListener('DOMContentLoaded', function() {
    ...
    sr.reveal('.ciencia-intro-section .sectiontitle', {
        origin: 'top',
        distance: '40px',
        duration: 1500,
        delay: 200
    ...
    sr.reveal('.thought-bubble-science', {
        origin: 'right',
        distance: '60px',
        duration: 2000,
        delay: 400
    ...
    sr.reveal('.juegos-ciencias-section .sectiontitle', {
        origin: 'top',
        distance: '40px',
        duration: 1500,
        delay: 200
