    ...
    <div class="gram-complete" style="background: radial-gradient(circle at top, rgba(156, 39, 176, 0.2), transparent 60%);">
      <div class="gram-card" style="border: 2px solid rgba(156, 39, 176, 0.2);">
        <div class="gram-card-header">
          <p class="final-label" style="color: #9c27b0;">Inglés EduReto</p>
          <div class="gram-trophy" style="background: rgba(156, 39, 176, 0.12); color: #9c27b0;">
            <i class='bx bx-world'></i>
          </div>
          <h2>¡Aventura completada!</h2>
          <p>Exploraste ${totalLocations} ubicaciones y completaste ${totalMissions} misiones en inglés.</p>
        </div>
        <div class="gram-stats">
          ...
          <div class="gram-stat" style="background: #f3e5f5; border: 1px solid rgba(156, 39, 176, 0.35);">
            <span style="color: #7b1fa2;">Misiones</span>
            <strong style="color: #6a1b9a;">${missionsCompleted}/${totalMissions}</strong>
          </div>
          <div class="gram-stat" style="background: #f3e5f5; border: 1px solid rgba(156, 39, 176, 0.35);">
            <span style="color: #7b1fa2;">Ubicaciones</span>
            <strong style="color: #6a1b9a;">${totalLocations}</strong>
          </div>
        </div>
        <div class="gram-buttons">
          ...
          <button class="action-button" id="replay-game" style="background: #9c27b0; color: #fff; box-shadow: 0 10px 20px rgba(156, 39, 176, 0.4);">
