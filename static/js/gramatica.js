/*ScrollReveal Animations para gramatica.html*/
document.addEventListener('DOMContentLoaded', function() {
    ...
    sr.reveal('.gramatica-intro-section .sectiontitle', {
        origin: 'top',
        distance: '40px',
        duration: 1500,
        delay: 200
    ...
    sr.reveal('.juegos-gramatica-section .sectiontitle', {
        origin: 'top',
        distance: '40px',
        duration: 1500,
        delay: 200
